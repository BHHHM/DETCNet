...
if __name__ == "__main__":
    ...
    name_classes = ["background", "road","secondroad","third","four"]
    # ----------------------------------------------------------------------------------------------------------#
    ...
    # -------------------------------------------------------------------------#
    dir_origin_path = "img_gggg"
    dir_save_path = "imgout_gggg/a5"
    # -------------------------------------------------------------------------#
    ...
    if mode == "predict":
        ...
        while True:
            ...
            save_path = input('Input the save path for the processed image: ')
