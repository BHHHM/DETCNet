...
if __name__ == '__main__':
    jpgs_path   = "VOCdevkit/JPEGImages"
    pngs_path   = "VOCdevkit/SegmentationClass"
    classes     = ["_background_","road"]

    # classes     = ["_background_","cat","dog"]
    
    count = os.listdir("./roadtry/before/")
    for i in range(0, len(count)):
        path = os.path.join("./roadtry/before", count[i])
