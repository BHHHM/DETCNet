...
# from nets.HRUnet import Unet as unet
# from My_SCI.cdc6 import Unet as unet
from utils.utils2 import cvtColor, preprocess_input, resize_image, show_config
...
class Unet(object):
    _defaults = {
        ...
        # -------------------------------------------------------------------#
        "model_path": r'F:\AAABHM\GuiLin\logs_nn\ep005-loss0.000-val_loss0.000.pth',  # 使用别人的权重，训练的快一点
        # --------------------------------#
        #   所需要区分的类的个数+1
        # --------------------------------#
        "num_classes": 4,
    ...
    #   检测图片
    # ---------------------------------------------------#
    def detect_image(self, image, count=False, name_classes=2):
        # ---------------------------------------------------------#
